...
<body class="animsition">
    ...
    <script src="{{asset('code.jquery.com/jquery-3.3.1.slim.min.js')}}" ></script>
    <script src="{{asset('cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js')}}"></script>
    <script src="{{asset('stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js')}}" ></script>
